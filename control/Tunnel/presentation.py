...
#    plt.plot(x, SER)
    ...
    plt.ylabel('SER (dB)')
    plt.title('Shielding Due To Reflection for Tunnel')
...
#        plt.legend(loc='center left', bbox_to_anchor=(1, 0.5))
    fig.savefig('SER_single_title', bbox_inches='tight')
#print(f)
for i in range(N):
    if i == 0:
        continue
...
#        plt.legend(loc='center left', bbox_to_anchor=(1, 0.5))
    fig.savefig('Total_SE_single_title', bbox_inches='tight')
'''        
    fig = plt.figure(69)
    plt.xlabel('Frequancy (Hz)')
    plt.ylabel('Log Magnitude (dB)')
...
#    print(S11, 'S11')
    S1.append(S11)
fig = plt.figure(901)
plt.title('Sheilding Effectivness Due To Absorption For Tunnel')
plt.xlabel('Frequency (Hz)')
...
plt.legend(loc='center left', bbox_to_anchor=(1, 0.5))
fig.savefig('SEA_single_title', bbox_inches='tight')
#print(SEA1)
