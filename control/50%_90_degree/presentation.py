...
#    plt.plot(x, SER)
    ...
    plt.ylabel('SER (dB)')
    plt.title('Shielding Due To Reflection 50% fill density 90 degree build w/ subtraction', x = 0.5, y = 1.1)
...
#        plt.plot(x, SER_Tunnel, label = 'tunnel 1')
        plt.plot(x, Ser, label = 'subtracted sample')
        plt.legend(loc='center left', bbox_to_anchor=(1, 0.5))
#    if i == 4:
...
#        plt.legend(loc='center left', bbox_to_anchor=(1, 0.5))
    fig.savefig('SER_single_title_wsubtraction', bbox_inches='tight')
#print(f)
for i in range(N):
    if i == 0:
        continue
...
#        plt.legend(loc='center left', bbox_to_anchor=(1, 0.5))
    ...
    plt.title(name_dict[i])
    fig = plt.figure(9)
    plt.title('Total SE for 50% fill density 90 degree build w/ subtraction')
    plt.xlabel('Frequency (Hz)')
...
#        plt.plot(x, Total_SE, label = 'Sample1')
        plt.plot(x, sample, label = 'subtraction 1')
        plt.legend(loc='center left', bbox_to_anchor=(1, 0.5))
#    if i == 6:
#        plt.plot(x, Total_SE, label = 'Sample2')
#        plt.plot(x, sample, label = 'subtraction2')
#        plt.legend(loc='center left', bbox_to_anchor=(1, 0.5))
#    if i == 10:
#        plt.plot(x, Total_SE, label = 'Sample3')
#        plt.plot(x, sample, label = 'subtraction3')
#        plt.legend(loc='center left', bbox_to_anchor=(1, 0.5))
#    if i == 14:
...
#    if i == 18:
#        plt.plot(x, Total_SE, label = 'Sample4')
#        plt.plot(x, sample, label = 'subtraction 4')
#        plt.legend(loc='center left', bbox_to_anchor=(1, 0.5))
    fig.savefig('Total_SE_single_title_wsubtraction', bbox_inches='tight')
'''        
    fig = plt.figure(69)
    plt.xlabel('Frequancy (Hz)')
    plt.ylabel('Log Magnitude (dB)')
    plt.title('Total Shielding Effectveness - Tunnel')
#    plt.plot(x, mag)
    if i == 2:
        sample1 = Total_SE - Total_SE_Tunnel
        plt.plot(x, sample1, label = 'Sample1')
        plt.legend(loc='center left', bbox_to_anchor=(1, 0.5))
    if i == 6:
        sample2 = Total_SE - Total_SE_Tunnel
        plt.plot(x, sample2, label = 'Sample2')
        plt.legend(loc='center left', bbox_to_anchor=(1, 0.5))
    if i == 10:
        sample3 = Total_SE - Total_SE_Tunnel
        plt.plot(x, sample3, label = 'Sample3')
        plt.legend(loc='center left', bbox_to_anchor=(1, 0.5))
#    if i == 14:
#        plt.plot(x, mag, label = 'Sample4')
#        plt.legend(loc='center left', bbox_to_anchor=(1, 0.5))
    if i == 18:
        sample4 = Total_SE - Total_SE_Tunnel
        plt.plot(x, sample4, label = 'Sample4')
        plt.legend(loc='center left', bbox_to_anchor=(1, 0.5))
...
#    print(S11, 'S11')
    S1.append(S11)
fig = plt.figure(901)
plt.title('Sheilding Effectivness Due To Absorption for 50% fill density 90 degree build with subtraction')
plt.xlabel('Frequency (Hz)')
...
sample4 = SEA5 - SEA_Tunnel


#plt.plot(x, SEA1, label = 'Sample1')
plt.plot(x, sample1, label = 'subtracted1')
plt.legend(loc='center left', bbox_to_anchor=(1, 0.5))
fig.savefig('SEA_single_title_wsubtraction', bbox_inches='tight')
#print(SEA1)


#plt.plot(x, SEA2, label = 'Sample2')
#plt.plot(x, sample2, label = 'subtracted2')
#plt.legend(loc='center left', bbox_to_anchor=(1, 0.5))


#plt.plot(x, SEA3, label = 'Sample3')
#plt.plot(x, sample3, label = 'subtracted3')
#plt.legend(loc='center left', bbox_to_anchor=(1, 0.5))
...
#plt.plot(x, sample4, label = 'subtracted4')
#plt.legend(loc='center left', bbox_to_anchor=(1, 0.5))
#print(S1, 'S11')
#print(S2, 'S22')
...
'''    for j in range(N):
        ...
        S2.append(S12)
        fig = plt.figure(900)
        SEA = -10 * log10(np.abs(S12[1])**2 / (1 - np.abs(S11[1])**2))
#        print(S12, 'S12')
    #    print(mag)
    #    [S11, S21, S12,S22]
    #    y = np.append(mag)
...
#    if i == 2 == 0:
#        plt.plot(x, SEA, label = 'Sample1')
#        plt.legend(loc='center left', bbox_to_anchor=(1, 0.5))
#    if i == 6 == 4:
#        plt.plot(x, SEA, label = 'Sample2')
#        plt.legend(loc='center left', bbox_to_anchor=(1, 0.5))
#    if i == 10 == 8:
#        plt.plot(x, SEA, label = 'Sample3')
#        plt.legend(loc='center left', bbox_to_anchor=(1, 0.5))
#    if i == 14 == 12:
#        plt.plot(x, SEA, label = 'Sample4')
#        plt.legend(loc='center left', bbox_to_anchor=(1, 0.5))
#    if i == 18 == 16:
#        plt.plot(x, SEA, label = 'Sample5')
#        plt.legend(loc='center left', bbox_to_anchor=(1, 0.5))'''
