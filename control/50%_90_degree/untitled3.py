...
#    plt.plot(x, mag)
    if i == 0:
        ...
        plt.annotate("With Sample", xy=(8, -6), xytext=(8.5, -6), arrowprops=dict(arrowstyle="->"))
...
#        plt.legend(loc='center left', bbox_to_anchor=(1, 0.5))
    ...
    if i == 0:
        ...
        plt.annotate("Subtracted Value", xy=(8, 15), xytext=(8.5, 20), arrowprops=dict(arrowstyle="->"))
        #plt.plot(x, tunnelS11, label = 'Average')
    if i == 4:
    ...
    if i == 0:
        plt.plot(x, tunnelS11, label = 'tunnel')
        plt.annotate("Without Sample", xy=(8, -22), xytext=(8.5, -35), arrowprops=dict(arrowstyle="->"))
...
#    plt.plot(x, mag)
    ...
    if i == 1:
        plt.plot(x, mag, label = 'Sample1')
        plt.plot(x, TunnelS21, label = 'S21 Average')
        plt.legend(loc='center left', bbox_to_anchor=(1, 0.5))
    if i == 5:
        plt.plot(x, mag, label = 'Sample2')
        plt.legend(loc='center left', bbox_to_anchor=(1, 0.5))
...
#    plt.plot(x, mag)
    if i == 2:
        plt.plot(x, mag, label = 'Sample1')
        plt.plot(x, TunnelS12, label = 'S12 average')
        plt.legend(loc='center left', bbox_to_anchor=(1, 0.5))
    if i == 6:
        plt.plot(x, mag, label = 'Sample2')
        plt.legend(loc='center left', bbox_to_anchor=(1, 0.5))
...
#    plt.plot(x, mag)
    ...
    if i == 3:
        plt.plot(x, mag, label = 'Sample1')
        plt.plot(x, TunnelS22, label = 'S22 Average')
        plt.legend(loc='center left', bbox_to_anchor=(1, 0.5))
    if i == 7:
        plt.plot(x, mag, label = 'Sample2')
        plt.legend(loc='center left', bbox_to_anchor=(1, 0.5))
